...
def test_distill_bert(basepath, task, bert_type, max_seq_length=128):
    ...
    init_checkpoint_distilled = '%smodel.ckpt-33672' % (distill_output_dir)
    ...
    model_fn = model_fn_builder_distill(
        ...
        init_checkpoint=init_checkpoint_distilled,
    ...
    file_based_convert_examples_to_features(
        dev_examples, label_list, max_seq_length, tokenizer, eval_file)
    ...
    output_predict_file = os.path.join(distill_output_dir, "test_results.tsv")
...
if __name__=='__main__':
    ...
    test_distill_bert(args.p, args.t, args.b)
